    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><a href="{{ route('role.create') }}" class="btn btn-xs btn-primary"> Add role</a> Role index page</h3>
                    ...
                    <tbody>
                        @foreach ($roles as $role )
                            <tr>
                                ...
                                <td>{{ $role->name }}</td>
                                <td>
                                    <a href="{{ route('role.edit', $role->id) }}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="Edit role !"><span class="glyphicon glyphicon-edit"></span></a>
                                </td>
                                <td>
