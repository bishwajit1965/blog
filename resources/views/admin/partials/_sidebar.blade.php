<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="header">Laravel Blog</li>
            <li class="treeview">
                <a href="#">
            ...
            <li class="treeview">
                ...
                @if (Auth::user()->status == 1)
                    <li>
                        <a href="{{ route('user.index') }}"><i class="fa fa-circle-o"></i> Admin users</a>
                    </li>
                @endif

                <li class="{{ Request::is()?'active':'' }}"><a href="{{ route('admin.home') }}"><i class="fa fa-circle-o"></i> Home</a></li>
