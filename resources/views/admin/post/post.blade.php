    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Create post here</h3>
            ...
            {{-- Code below --}}
                ...
                <form role="form" action="{{route('post.store')}}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="title">Post title</label>
                                <input type="text" name="title" class="form-control" id="title" placeholder="Provide post title data...">
                            </div>
                            <div class="form-group">
                                <label for="subtitle">Sub title</label>
                                <input type="text" name="subtitle" class="form-control" id="subtitle" placeholder="Provide subtitle data...">
                            </div>
                            <div class="form-group">
                                <label for="slug">Post slug</label>
                                <input type="text" name="slug" class="form-control" id="slug" placeholder="Provide slug data...">
                            </div>
                            <div class="form-group">
                                <label for="posted_by">Posted by</label>
                                <input type="text" name="posted_by" class="form-control" id="posted_by" placeholder="Provide posted by data...">
                            </div>
                        </div>
                        <div class="col-sm-6">   
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="status" id="status" value="1"> Check to publish
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
